...
def edit_save():
  try:
    ...
    scheme_items = bool(data.get("scheme_items", False))
    event_tickets = bool(data.get("event_tickets", False))
    reset_golden_cat_cpus = bool(data.get("reset_golden_cat_cpus", False))
    unlock_cat_guide = bool(data.get("unlock_cat_guide", False))
    cat_storage = bool(data.get("cat_storage", False))
    clear_enigma_stages = bool(data.get("clear_enigma_stages", False))
    unlock_aku_realm = bool(data.get("unlock_aku_realm", False))
    outbreaks = bool(data.get("outbreaks", False))
    aku_chapters = bool(data.get("aku_chapters", False))
    filibuster_reclearing = bool(data.get("filibuster_reclearing", False))
    sol = bool(data.get("sol", False))
    event = bool(data.get("event", False))
    collab = bool(data.get("collab", False))
    gauntlets = bool(data.get("gauntlets", False))
    collab_gauntlets = bool(data.get("collab_gauntlets", False))
    uncanny = bool(data.get("uncanny", False))
    catamin_stages = bool(data.get("catamin_stages", False))
    behemoth_culling = bool(data.get("behemoth_culling", False))
    legend_quest = bool(data.get("legend_quest", False))
    towers = bool(data.get("towers", False))
    zero_legends = bool(data.get("zero_legends", False))
    dojo_catclaw_championships = bool(data.get("dojo_catclaw_championships", False))
    cat_shrine = bool(data.get("cat_shrine", False))
    ototo_cat_cannon = bool(data.get("ototo_cat_cannon", False))
    unban_account = bool(data.get("unban_account", False))
    upload_items = bool(data.get("upload_items", False))
    inquiry_code = bool(data.get("inquiry_code", False))
    password_refresh_token = bool(data.get("password_refresh_token", False))
    fix_gamatoto_crash = bool(data.get("fix_gamatoto_crash", False))
    fix_ototo_crash = bool(data.get("fix_ototo_crash", False))
    fix_time_errors = bool(data.get("fix_time_errors", False))
    unlock_equip_menu = bool(data.get("unlock_equip_menu", False))
    fix_officer_pass_crash = bool(data.get("fix_officer_pass_crash", False))
    unlocked_slots = bool(data.get("unlocked_slots", False))
    reset_gambling_events = bool(data.get("reset_gambling_events", False))
    restart_pack = bool(data.get("restart_pack", False))
    enemy_guide = bool(data.get("enemy_guide", False))
    medals = bool(data.get("medals", False))
    missions = bool(data.get("missions", False))
    battle_items_endless = safe_int(data.get("battle_items_endless"))
    challenge_score = safe_int(data.get("challenge_score"))
    dojo_score = safe_int(data.get("dojo_score"))
    itf_timed_scores = safe_int(data.get("itf_timed_scores"))
    rare_gatya_seed = safe_int(data.get("rare_gatya_seed"))
    normal_gatya_seed = safe_int(data.get("normal_gatya_seed"))
    event_gatya_seed = safe_int(data.get("event_gatya_seed"))
    playtime = safe_int(data.get("playtime"))
    ...
    res, codes = patch_and_upload_save(
        ...
        reset_golden_cat_cpus=reset_golden_cat_cpus,
        unlock_cat_guide=unlock_cat_guide,
        cat_storage=cat_storage,
        clear_enigma_stages=clear_enigma_stages,
        unlock_aku_realm=unlock_aku_realm,
        outbreaks=outbreaks,
        aku_chapters=aku_chapters,
        filibuster_reclearing=filibuster_reclearing,
        sol=sol,
        event=event,
        collab=collab,
        gauntlets=gauntlets,
        ...
        uncanny=uncanny,
        catamin_stages=catamin_stages,
        behemoth_culling=behemoth_culling,
        legend_quest=legend_quest,
        towers=towers,
        zero_legends=zero_legends,
        dojo_catclaw_championships=dojo_catclaw_championships,
        cat_shrine=cat_shrine,
        ototo_cat_cannon=ototo_cat_cannon,
        unban_account=unban_account,
        upload_items=upload_items,
        inquiry_code=inquiry_code,
        password_refresh_token=password_refresh_token,
        fix_gamatoto_crash=fix_gamatoto_crash,
        fix_ototo_crash=fix_ototo_crash,
        fix_time_errors=fix_time_errors,
        unlock_equip_menu=unlock_equip_menu,
        fix_officer_pass_crash=fix_officer_pass_crash,
        unlocked_slots=unlocked_slots,
        reset_gambling_events=reset_gambling_events,
        restart_pack=restart_pack,
        enemy_guide=enemy_guide,
        medals=medals,
        missions=missions,
        battle_items_endless=battle_items_endless,
        challenge_score=challenge_score,
        dojo_score=dojo_score,
        itf_timed_scores=itf_timed_scores,
        rare_gatya_seed=rare_gatya_seed,
        normal_gatya_seed=normal_gatya_seed,
        event_gatya_seed=event_gatya_seed,
        playtime=playtime,
